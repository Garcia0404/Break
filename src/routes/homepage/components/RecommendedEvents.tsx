    ...
    <li className="min-w-full h-full relative">
      <article className="h-full w-full">
        ...
        <div className="absolute top-[50%] px-10 left-0 z-40 ">
          <h3 className="z-50 text-white text-3xl sm:text-5xl font-bold">{title}</h3>
          <div className="flex gap-4 my-6">
            <div className="flex items-center max-sm:text-sm gap-1 bg-[rgba(234,179,8,0.2)] text-[#fde047] px-3 rounded-xl">
              <CalendarSvg size="4"/>
              <span>{date}</span>
            </div>
            <div className="flex items-center max-sm:text-sm gap-1 bg-[rgba(168,85,247,0.2)] text-[#d8b4fe] px-3 rounded-xl">
              <AttendeesSvg size="4"/>
...
export const RecommendedEvents = () => {
  return (
    <section className="relative text-white bg-[#18181B] md:col-start-1 md:col-end-7 md:row-start-1 md:row-end-3 overflow-hidden">
      ...
      <h2 className="absolute top-0 left-0 text-3xl sm:text-4xl font-bold p-8 z-40">⭐ Eventos Recomendados</h2>
